...
pub fn deriv2_approx_eq<F, A>(d2fdx2: f64, at_x: f64, args: &mut A, tol: f64, f: F)
where
...
mod tests {
    ...
    fn panics_on_function_error() {
        let args = &mut Arguments {};
        deriv2_approx_eq(0.0, 1.5, args, 1e-1, &placeholder);
    }
    ...
    fn panics_on_nan_1() {
        let args = &mut Arguments {};
        deriv2_approx_eq(f64::NAN, 1.5, args, 1e-1, &placeholder);
    }
    ...
    fn panics_on_inf_1() {
        let args = &mut Arguments {};
        deriv2_approx_eq(f64::INFINITY, 1.5, args, 1e-1, &placeholder);
    }
    ...
    fn panics_on_nan_2() {
        ...
        let args = &mut Arguments {};
        deriv2_approx_eq(0.0, 1.5, args, 1e-1, f);
    }
    ...
    fn panics_on_different_deriv() {
        ...
        let at_x = 1.5;
        let ana = 1.51;
        deriv2_approx_eq(ana, at_x, args, 1e-2, f);
    }
