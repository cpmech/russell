...
pub struct OdeSample {
    ...
    pub output_step: Option<Box<dyn FnMut(usize, f64, f64, &Vector) -> Result<bool, StrError>>>,
    pub output_dense: Option<Box<dyn FnMut(&mut Vector, f64, usize, f64, f64, &Vector) -> Result<bool, StrError>>>,
