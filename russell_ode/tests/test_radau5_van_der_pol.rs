...
fn test_radau5_van_der_pol() {
    ...
    out.set_dense_h_out(0.2).unwrap().set_dense_recording(&[0, 1]);
    ...
    approx_eq(y0[0], 1.706163410178079E+00, 1e-12);
    approx_eq(y0[1], -8.927971289301175E-01, 1e-11);
    approx_eq(stat.h_accepted, 1.510987221365367E-01, 1e-7);
