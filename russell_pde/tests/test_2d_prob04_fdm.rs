...
#[test]
fn test_2d_prob04_fdm_sps() -> Result<(), StrError> {
    ...
    fdm.for_each_coord(|m, x, y| {
        ...
        approx_eq(a[m], analytical(x, y), 0.0023);
    });
    ...
    if SAVE_FIGURE {
        ...
        plot.set_equal_axes(true)
            ...
            .save("/tmp/russell_pde/test_2d_prob04_fdm_sps.svg")?;
    }
    Ok(())
}

#[test]
fn test_2d_prob04_fdm_lmm() -> Result<(), StrError> {
    // get the problem data
    let (xmin, xmax, ymin, ymax, kx, ky, ebcs, nbcs, source, analytical) = ProblemSamples::d2_problem_04(101);
