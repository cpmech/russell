...
impl SparseTriplet {
    ...
    /// use russell_sparse::*;
    /// let trip = SparseTriplet::new(2, 2, 1, EnumSymmetry::Auto)?;
    ...
    /// let mut trip = SparseTriplet::new(4, 4, 6+1, EnumSymmetry::Auto)?;
    ...
    /// let mut trip = SparseTriplet::new(4, 3, 6, EnumSymmetry::Auto)?;
    /// trip.put(0, 0, 1.0);
    /// trip.put(1, 0, 2.0);
    /// trip.put(1, 1, 3.0);
    /// trip.put(2, 0, 4.0);
...
mod tests {
    ...
    fn new_fails_on_wrong_input() {
        assert_eq!(
            SparseTriplet::new(0, 3, 5, EnumSymmetry::Auto).err(),
            Some("nrow, ncol, and max must all be greater than zero")
        );
        assert_eq!(
            SparseTriplet::new(3, 0, 5, EnumSymmetry::Auto).err(),
            Some("nrow, ncol, and max must all be greater than zero")
        );
        assert_eq!(
            SparseTriplet::new(3, 3, 0, EnumSymmetry::Auto).err(),
            Some("nrow, ncol, and max must all be greater than zero")
        );
    }
    ...
    fn new_works() -> Result<(), &'static str> {
        let trip = SparseTriplet::new(3, 3, 5, EnumSymmetry::Auto)?;
    ...
    fn put_panics_on_wrong_values_1() {
        let mut trip = SparseTriplet::new(1, 1, 1, EnumSymmetry::Auto).unwrap();
        trip.put(1, 0, 0.0);
    }
    ...
    fn to_matrix_fails_on_wrong_dims() -> Result<(), &'static str> {
        let trip = SparseTriplet::new(1, 1, 1, EnumSymmetry::Auto)?;
    ...
    fn mat_vec_mul_works() -> Result<(), &'static str> {
        ...
        let mut trip = SparseTriplet::new(3, 5, 15, EnumSymmetry::Auto)?;
        trip.put(0, 0, 1.0);
        trip.put(0, 1, 2.0);
        trip.put(0, 2, 3.0);
        trip.put(0, 3, 4.0);
