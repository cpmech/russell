...
mod samples_tensor4;
mod spectral2;
mod spectral_auxiliary;
mod spectral_derivs;
mod spectral_eigenprojs;
mod spectral_eigenvals;
mod tensor1;
mod tensor2;
mod tensor3;
mod tensor4;
