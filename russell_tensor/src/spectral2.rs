...
pub struct Spectral2 {
    ...
    /// Holds the eigenprojectors; set of 3 symmetric Tensor2
...
impl Spectral2 {
    ...
    pub fn decompose(&mut self, tt: &Tensor2<6>) -> Result<(), StrError> {
...
mod tests {
    use super::Spectral2;
    use crate::{SQRT_3, SQRT_3_BY_2, SampleTensor2, SamplesTensor2, Tensor2};
